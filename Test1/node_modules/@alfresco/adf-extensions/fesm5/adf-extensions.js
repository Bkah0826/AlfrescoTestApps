                    ...
                    if (config_1.$references && config_1.$references.length > 0) {
                        ...
                        function (results) {
                            ...
                            if (extensions && extensions.length > 0) {
                                configs.push.apply(configs, __spread(extensions));
                            }
                            if (configs.length > 0) {
