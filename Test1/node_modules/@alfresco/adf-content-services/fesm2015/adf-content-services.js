...
import { NgModule, Injectable, Directive, ElementRef, Renderer2, HostListener, Input, Component, ViewEncapsulation, ViewChild, ViewContainerRef, ComponentFactoryResolver, Inject, EventEmitter, Output, NgZone, Optional, SecurityContext, Pipe, ContentChild, ChangeDetectionStrategy, defineInjectable, inject, forwardRef, ChangeDetectorRef, TemplateRef, ViewChildren, HostBinding } from '@angular/core';
import { FormBuilder, FormsModule, ReactiveFormsModule, NG_VALUE_ACCESSOR, FormControl, Validators, FormGroup } from '@angular/forms';
import { AlfrescoApiService, LogService, ContentService, CoreModule, TranslationService, ObjectDataTableAdapter, SearchService, AuthenticationService, ThumbnailService, UserPreferencesService, FileUploadStatus, UploadService, FileModel, NodesApiService, EXTENDIBLE_COMPONENT, FileUtils, AllowableOperationsEnum, NotificationService, BaseEvent, DataSorting, ObjectUtils, MOMENT_DATE_FORMATS, UserPreferenceValues, MomentDateAdapter, CardViewUpdateService, SitesService, AppConfigService, TRANSLATION_PROVIDER, CardViewTextItemModel, CardViewDateItemModel, FileSizePipe, CardViewIntItemModel, CardViewFloatItemModel, CardViewDatetimeItemModel, CardViewBoolItemModel, MultiValuePipe, DecimalNumberPipe, HighlightDirective, InfinitePaginationComponent, SharedLinksApiService, RenditionsService, SearchConfigurationService, DisplayMode, ObjectDataColumn, LockService, DataColumnListComponent, CustomLoadingContentTemplateDirective, CustomNoPermissionTemplateDirective, CustomEmptyContentTemplateDirective, NodeDownloadDirective } from '@alfresco/adf-core';
