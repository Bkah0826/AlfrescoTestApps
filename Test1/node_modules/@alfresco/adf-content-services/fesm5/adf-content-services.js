...
import { catchError, map, switchMap, takeUntil, debounceTime, filter, mergeMap, skip, distinctUntilChanged } from 'rxjs/operators';
import { CommonModule, DOCUMENT } from '@angular/common';
import { NgModule, Injectable, Directive, ElementRef, Renderer2, HostListener, Input, Component, ViewEncapsulation, Inject, EventEmitter, Output, ViewChild, NgZone, SecurityContext, Optional, Pipe, ChangeDetectionStrategy, ComponentFactoryResolver, ViewContainerRef, defineInjectable, inject, forwardRef, ChangeDetectorRef, ViewChildren, ContentChild, TemplateRef, HostBinding } from '@angular/core';
import { FormBuilder, FormsModule, ReactiveFormsModule, NG_VALUE_ACCESSOR, FormControl, Validators, FormGroup } from '@angular/forms';
import { AlfrescoApiService, LogService, CoreModule, TranslationService, ObjectDataTableAdapter, ContentService, AuthenticationService, ThumbnailService, UserPreferencesService, SearchService, FileUploadStatus, UploadService, FileModel, FileUtils, DataSorting, ObjectUtils, NodesApiService, AllowableOperationsEnum, MOMENT_DATE_FORMATS, UserPreferenceValues, MomentDateAdapter, CardViewUpdateService, SitesService, AppConfigService, TRANSLATION_PROVIDER, CardViewTextItemModel, CardViewDateItemModel, FileSizePipe, CardViewIntItemModel, CardViewFloatItemModel, CardViewDatetimeItemModel, CardViewBoolItemModel, MultiValuePipe, DecimalNumberPipe, HighlightDirective, InfinitePaginationComponent, SharedLinksApiService, RenditionsService, SearchConfigurationService, EXTENDIBLE_COMPONENT, NotificationService, DisplayMode, ObjectDataColumn, LockService, DataColumnListComponent, CustomLoadingContentTemplateDirective, CustomNoPermissionTemplateDirective, CustomEmptyContentTemplateDirective, BaseEvent, NodeDownloadDirective } from '@alfresco/adf-core';
 ...
 */
/** @type {?} */
var searchAnimation = trigger('transitionMessages', [
    state('active', style({
...
var SearchDateRangeComponent = /** @class */ (function () {
    ...
    function () {
         ...
         * @return {?}
         */
        function (locale) { return _this.setLocale(locale); }));
        /** @type {?} */
     ...
     * @return {?}
     */
    SearchDateRangeComponent.prototype.ngOnDestroy = /**
     * @return {?}
     */
    function () {
        this.onDestroy$.next(true);
...
var PropertyGroupTranslatorService = /** @class */ (function () {
    ...
    /** @nocollapse */ PropertyGroupTranslatorService.ngInjectableDef = defineInjectable({ factory: function PropertyGroupTranslatorService_Factory() { return new PropertyGroupTranslatorService(inject(LogService), inject(MultiValuePipe), inject(DecimalNumberPipe), inject(AppConfigService)); }, token: PropertyGroupTranslatorService, providedIn: "root" });
