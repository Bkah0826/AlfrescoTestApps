    ...
    ***************************************************************************** */
    ...
    var DocumentListComponent = /** @class */ (function () {
        function DocumentListComponent(documentListService, ngZone, elementRef, appConfig, userPreferencesService, contentService, thumbnailService, alfrescoApiService, lockService) {
            ...
            this.userPreferencesService
                .select(i1$1.UserPreferenceValues.PaginationSize)
                .pipe(operators.takeUntil(this.onDestroy$))
                .subscribe(( /**
         * @param {?} pagSize
         * @return {?}
    ...
    var SearchDateRangeComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                this.userPreferencesService
                    .select(i1$1.UserPreferenceValues.Locale)
                    .pipe(operators.takeUntil(this.onDestroy$))
                    .subscribe(( /**
             * @param {?} locale
             * @return {?}
         ...
         */
            function (property, propertyValues) {
                ...
                switch (property.dataType) {
                    ...
                    case D_FLOAT:
                    case D_DOUBLE:
                        cardViewItemProperty = new i1$1.CardViewFloatItemModel(Object.assign(propertyDefinition, {
    ...
    var ContentMetadataComponent = /** @class */ (function () {
         ...
         */
             ...
             * @return {?}
             */function (changes) {
                    return _this.saveNode(changes).pipe(operators.catchError(( /**
                     * @param {?} err
                     * @return {?}
                     */function (err) {
    ...
    var ShareDialogComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                this.form.controls.time.valueChanges
                    .pipe(operators.skip(1), operators.distinctUntilChanged(), operators.mergeMap(( /**
             * @param {?} updates
             * @return {?}
             */function (updates) { return _this.updateNode(updates); }), ( /**
                 * @param {?} formUpdates
                 * @return {?}
                 */function (formUpdates) { return formUpdates; })), operators.catchError(( /**
                 * @param {?} error
                 * @return {?}
                 */function (error) {
         ...
         */
            function () {
                ...
                this.form.setValue({
                    ...
                    time: expiryDate ? moment$2(expiryDate).local() : null
                });
            };
        /**
         * @private
        ...
        ShareDialogComponent.propDecorators = {
            matDatetimepickerToggle: [{ type: i0.ViewChild, args: ['matDatetimepickerToggle',] }],
            slideToggleExpirationDate: [{ type: i0.ViewChild, args: ['slideToggleExpirationDate',] }],
            dateTimePickerInput: [{ type: i0.ViewChild, args: ['dateTimePickerInput',] }]
        };
    ...
    var NodeSharedDirective = /** @class */ (function () {
         ...
         */
            function (nodeId) {
                ...
                return rxjs.from(this.alfrescoApiService.nodesApi.getNodeInfo(nodeId, options));
            };
        /**
         * @private
         * @param {?} node
    ...
    exports.ɵl = ContentMetadataComponent;
    exports.ɵc = NodeLockDirective;
    exports.ɵb = MaterialModule;
    exports.ɵa = modules;
    exports.ɵm = SearchPermissionConfigurationService;
    exports.ɵd = searchAnimation;
    exports.ɵj = SearchCheckListComponent;
    exports.ɵk = SearchDateRangeComponent;
    exports.ɵi = SearchNumberRangeComponent;
    exports.ɵg = SearchRadioComponent;
    exports.ɵh = SearchSliderComponent;
    exports.ɵf = SearchTextComponent;
    exports.ɵe = SearchWidgetContainerComponent;
